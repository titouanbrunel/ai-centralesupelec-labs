    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                newCornersVisited = corners_visited
                if nextPosition in self.corners and nextPosition not in corners_visited:
                    newCornersVisited = tuple(sorted(corners_visited + (nextPosition,)))
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    distances = [mazeDistance(position, food, problem.startingGameState) 
